...
export const navItems: NavItem[] = [
  {
    ...
    roles: ["platform_admin", "organization_admin", "architect", "data_engineer", "qa_lead", "qa_engineer", "viewer", "guest"],
  },
  {
    id: "validations",
    label: "Validations",
    ...
    roles: ["platform_admin", "organization_admin", "architect", "data_engineer", "qa_lead", "qa_engineer"],
  },
  {
    id: "projects",
    label: "Projects",
  ...
  },
  {
    ...
    roles: ["platform_admin", "organization_admin", "architect", "data_engineer", "qa_lead", "qa_engineer", "viewer"],
  },
  {
    id: "reports",
    label: "Reports",
  ...
  },
  {
    ...
    roles: ["platform_admin", "organization_admin", "architect", "data_engineer", "qa_lead"],
  },
  {
    id: "ai-chatbot",
    label: "AI Chatbot",
  ...
  },
  {
    ...
    roles: ["platform_admin", "organization_admin", "architect", "data_engineer"],
  },
  {
    id: "accessibility",
    label: "Accessibility",
